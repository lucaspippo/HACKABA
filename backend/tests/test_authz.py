...
CASOS = [
    ...
    ("sales_list", "GET", "/api/sales", "emilio", "vendedor"),
    ("receipts_list", "GET", "/api/receipts", "emilio", "vendedor"),
    ("productos_list", "GET", "/api/productos", "emilio", "vendedor"),
    ("movimientos_list", "GET", "/api/movimientos", "emilio", "vendedor"),
...
CASOS_ADMIN = [
    ...
    ("odoo_ingest_contactos", "POST", "/api/conectores/odoo/ingest-contactos"),
