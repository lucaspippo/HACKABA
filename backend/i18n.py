...
CATALOGO: dict[str, dict[str, str]] = {
    ...
    "escena.regla_reclamo": {"es": "el reclamo va por {canal}, con {requisitos}",
                             "en": "claims go by {canal}, with {requisitos}"},
    "escena.dias": {"es": "días", "en": "days"},
    "escena.expansion_prov": {"es": "Lo que le enseñaron sobre {proveedor}",
                              "en": "What they taught about {proveedor}"},
    "escena.rel_le_enseñaron": {"es": "reglas que le enseñó el equipo",
                                "en": "rules the team taught"},
    ...
    "core.pdf.de": {"es": "de", "en": "from"},
    "core.pdf.falta": {"es": "falta", "en": "missing"},
    "core.pdf.renglones": {"es": "Renglones", "en": "Lines"},
    "core.pdf.disclaimer": {
    ...
    # --- la carpeta de documentos de una entrega (core/carpeta.py) -------
    "core.carpeta.ofrece_estado": {
        "es": "¿Te preparo el estado de cuenta de {cliente} para mandárselo?",
        "en": "Shall I prepare {cliente}'s account statement to send them?"},
    "core.carpeta.ofrece_remito": {
        "es": "¿Te preparo el remito del pedido {pedido}?",
        "en": "Shall I prepare the delivery note for order {pedido}?"},
    "core.carpeta.remito_t": {"es": "Remito de entrega", "en": "Delivery note"},
    "core.carpeta.remito_sub": {"es": "Lo que sale con el camión", "en": "What goes out on the truck"},
    "core.carpeta.remito_nota": {"es": "Regla de la casa: los renglones, el total y el saldo salen de la misma fuente. Si alguno no coincide, el control cruzado lo marca ANTES de que el camión salga — no cuando el cliente lo discute.", "en": "House rule: the lines, the total and the balance come from the same source. If one of them does not match, the cross-check flags it BEFORE the truck leaves — not when the customer argues about it."},
    "core.carpeta.estado_t": {"es": "Estado de cuenta", "en": "Account statement"},
    "core.carpeta.estado_sub": {"es": "Cómo viene {cliente} con los pagos", "en": "How {cliente} is doing on payments"},
    "core.carpeta.estado_nota": {"es": "El plazo que decide si este cliente está atrasado no es siempre el comercial: cuando hay una regla de la casa, manda la regla, y acá va citada con su fuente.", "en": "The term that decides whether this customer is late is not always the commercial one: when there is a house rule, the rule wins — quoted here with its source."},
    "core.carpeta.sec_entrega": {"es": "La entrega", "en": "The delivery"},
    "core.carpeta.sec_partes": {"es": "Las partes", "en": "The parties"},
    "core.carpeta.sec_mercaderia": {"es": "La mercadería", "en": "The goods"},
    "core.carpeta.sec_cliente": {"es": "El cliente", "en": "The customer"},
    "core.carpeta.sec_situacion": {"es": "Cómo viene", "en": "Where it stands"},
    "core.carpeta.sec_criterio": {"es": "El criterio de la casa", "en": "The house rule"},
    "core.carpeta.f_numero": {"es": "Número", "en": "Number"},
    "core.carpeta.f_pedido": {"es": "Pedido", "en": "Order"},
    "core.carpeta.f_fecha_prevista": {"es": "Fecha prevista", "en": "Due date"},
    "core.carpeta.f_transporte": {"es": "Transporte", "en": "Transport"},
    "core.carpeta.f_direccion": {"es": "Dirección de entrega", "en": "Delivery address"},
    "core.carpeta.f_estado_pedido": {"es": "Estado del pedido", "en": "Order status"},
    "core.carpeta.f_emisor": {"es": "Emisor", "en": "Issuer"},
    "core.carpeta.f_cliente": {"es": "Cliente", "en": "Customer"},
    "core.carpeta.f_cuit_cliente": {"es": "CUIT del cliente", "en": "Customer tax id"},
    "core.carpeta.f_tel_cliente": {"es": "Teléfono", "en": "Phone"},
    "core.carpeta.f_email": {"es": "Mail", "en": "Email"},
    "core.carpeta.f_ciudad": {"es": "Ciudad", "en": "City"},
    "core.carpeta.f_renglones": {"es": "Renglones", "en": "Lines"},
    "core.carpeta.f_total": {"es": "Total", "en": "Total"},
    "core.carpeta.f_saldo": {"es": "Saldo", "en": "Balance"},
    "core.carpeta.f_limite": {"es": "Límite de crédito", "en": "Credit limit"},
    "core.carpeta.f_disponible": {"es": "Disponible", "en": "Available"},
    "core.carpeta.f_plazo": {"es": "Plazo comercial (días)", "en": "Commercial term (days)"},
    "core.carpeta.f_dias": {"es": "Días sin pagar", "en": "Days without paying"},
    "core.carpeta.f_promedio": {"es": "Promedio histórico (días)", "en": "Historical average (days)"},
    "core.carpeta.f_regla": {"es": "Lo que dijo el dueño", "en": "What the owner said"},
    "core.carpeta.f_tolerancia": {"es": "Tolerancia acordada", "en": "Agreed tolerance"},
    "core.carpeta.f_veredicto": {"es": "Contra ese criterio", "en": "Against that rule"},
    "core.carpeta.dias_n": {"es": "{n} días", "en": "{n} days"},
    "core.carpeta.umbral_regla": {"es": "la regla de la casa", "en": "the house rule"},
    "core.carpeta.umbral_plazo": {"es": "el plazo comercial", "en": "the commercial term"},
    "core.carpeta.ver_pasado": {"es": "{dias} días: pasado de {umbral} por {cual}", "en": "{dias} days: past {umbral} by {cual}"},
    "core.carpeta.ver_dentro": {"es": "{dias} días: dentro de {umbral} por {cual}", "en": "{dias} days: within {umbral} by {cual}"},
    "core.carpeta.fu_pedido": {"es": "pedido {n}", "en": "order {n}"},
    "core.carpeta.fu_pedido_abierto": {"es": "pedido abierto de {cliente} ({fecha})", "en": "open order of {cliente} ({fecha})"},
    "core.carpeta.fu_cuenta": {"es": "cuenta corriente de {cliente}", "en": "account of {cliente}"},
    "core.carpeta.fu_empresa": {"es": "datos de la empresa", "en": "company details"},
    "core.carpeta.fu_regla": {"es": "regla de la casa {id}", "en": "house rule {id}"},
    "core.carpeta.cc_renglones": {"es": "Total: los renglones contra el total del pedido", "en": "Total: the lines against the order total"},
    "core.carpeta.cc_saldo": {"es": "Total del pedido contra el saldo de la cuenta", "en": "Order total against the account balance"},
    "core.carpeta.cc_cliente": {"es": "Cliente: el mismo en los dos documentos", "en": "Customer: the same on both documents"},
    "core.carpeta.cc_nota": {"es": "Los tres números salen de la misma fuente. Cada copia a mano es donde dejan de coincidir.", "en": "All three numbers come from the same source. Every manual copy is where they stop matching."},
    ...
    # -- channel names
    "mapaop.chips_afuera": {"es": "De afuera", "en": "From outside"},
    "mapaop.chips_adentro": {"es": "En PolPilot", "en": "In PolPilot"},
    ...
    # -- misc
    # -- the panel's guaranteed exit: go see this node's data in its section
    "mapaop.ver_en": {"es": "Ver en {seccion}", "en": "See in {seccion}"},
    "mapaop.sec_deposito": {"es": "Depósito", "en": "Warehouse"},
    "mapaop.sec_proveedores": {"es": "Proveedores", "en": "Suppliers"},
    "mapaop.sec_ordenes_compra": {"es": "Órdenes de compra",
                                  "en": "Purchase orders"},
    "mapaop.sec_cuentas": {"es": "Cuentas corrientes",
                           "en": "Customer accounts"},
    "mapaop.sec_cobranzas": {"es": "Cobranzas", "en": "Collections"},
    "mapaop.sec_caja": {"es": "Caja diaria", "en": "Daily till"},
    "mapaop.sec_movimientos": {"es": "Movimientos", "en": "Movements"},
    "mapaop.sec_equipo": {"es": "Mi equipo", "en": "My team"},
    "mapaop.sec_aprendizaje": {"es": "Aprendizaje continuo",
                               "en": "Continuous learning"},
    "mapaop.sec_auditoria": {"es": "Registro de auditoría",
                             "en": "Audit log"},
