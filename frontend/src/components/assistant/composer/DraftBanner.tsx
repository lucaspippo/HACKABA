  ...
  return (
    <div className="mb-2 flex items-center gap-2 rounded-2xl border border-linea bg-crema px-3 py-2 sombra-papel">
      <div className="min-w-0 flex-1">
        ...
        <p className="truncate text-xs text-tinta-suave">{preview}</p>
      </div>
      <button
        type="button"
        onClick={onRestore}
        className="flex shrink-0 items-center gap-1.5 rounded-full border border-violeta/30 px-2.5 py-1 text-xs font-semibold text-violeta outline-none transition-colors hover:bg-violeta hover:text-crema focus-visible:ring-2 focus-visible:ring-violeta"
      >
        <RotateCcw size={13} />
