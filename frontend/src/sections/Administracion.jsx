  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-tinta-suave">{t("administracion.subtitulo")}</p>
      </header>
      ...
      {/* Tareas de carga */}
      <section>
        <h2 className="mb-3 font-display text-lg font-bold">{t("administracion.lo_que_cargas")}</h2>
            ...
            return (
              <div key={t.label} className="flex items-center gap-3 rounded-[var(--radius-card)] border border-linea bg-crema px-4 py-3 sombra-papel">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-tinta-suave">{t.nota}</p>
                </div>
              </div>
            );
          })}
      ...
      <section>
        <h2 className="mb-3 font-display text-lg font-bold">{t("administracion.ordenar_sistema")}</h2>
        <div className="grid grid-cols-2 gap-3">
          <button onClick={() => onPreguntar("¿Cómo depuro los productos fantasma?")} className="rounded-[var(--radius-card)] border border-linea bg-crema p-4 text-left">
            ...
            <p className="text-sm text-tinta-suave">{t("administracion.fantasma_depurar")}</p>
          </button>
          <button onClick={() => onPreguntar("¿Qué productos están sin precio?")} className="rounded-[var(--radius-card)] border border-linea bg-crema p-4 text-left">
            ...
            <p className="text-sm text-tinta-suave">{t("administracion.sin_precio")}</p>
          </button>
        </div>
      </section>
      ...
      {/* Recordatorios */}
      <section>
        <h2 className="mb-3 font-display text-lg font-bold">{t("administracion.recordatorios")}</h2>
